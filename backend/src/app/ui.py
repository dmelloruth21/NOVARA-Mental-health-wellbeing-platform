...
_DESCRIPTION = (
    "**Novara** is an empathetic support assistant for students. "
...
def build_ui() -> gr.ChatInterface:
    ...
    return gr.ChatInterface(
        fn=chat_logic,
        title="Novara – Student Mental-Health Support",
        description=_DESCRIPTION,
        chatbot=gr.Chatbot(
            height=650,
            value=get_ui_history(),
            placeholder=(
                "Hi, I'm Nova. You can share how you're feeling or ask a "
...
def launch_ui() -> None:
    ...
    ui = build_ui()
    print("Novara is ready. Logs -> rag_reference_logs.jsonl")
